...
const StoryViewer = ({ viewStory, setViewStory}) => {
  ...
  return (
    ...
    items-center justify-center' style={{backgroundColor: viewStory.media_type === 'text' ? viewStory.background_color: '#000000'}}>
        ...
        sm:p-4 sm:px-8 backdrop-blur-2xl rounded-xl bg-black/50'>
            <img src={viewStory.user?.profile_picture} alt="" className='
        ...
        focus:outline-none'>
        <X size={18} className='w-8 h-8 hover:scale-110 transition cursor-pointer'/>
        </button>

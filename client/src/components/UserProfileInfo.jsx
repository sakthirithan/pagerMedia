...
import ProfileStatusCount from '../UI/ProfileStatusCount'
            ...
            <div className='w-full pt-16 md:pt-0 md:pl-36'>
                <div className='flex flex-col md:flex-row items-start justify-between'>
                    ...
                    {!profileId && 
                        ...
                        font-medium transition-colors mt-4 md:mt-0 cursor-pointer active:scale-98'>
                ...
                <div className='flex items-center gap-6 mt-6 border-t border-gray-200 pt-4'>
                    <ProfileStatusCount count={posts.length} title={'Posts'}/>
                    <ProfileStatusCount count={user.followers.length} title={'Followers'}/>
                    <ProfileStatusCount count={user.following.length} title={'Following'}/>
                </div>
            </div>

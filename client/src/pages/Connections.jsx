...
const Connections = () => {
  ...
  return (
    <div className="min-h-screen px-6 bg-linear-to-b from-slate-50 to-white">
      <div className="max-w-6xl p-6">
        {/* Title  */}
        <PageHeader
          title="Connections"
          desc="Manage your network and discover new connections"
        />
            ...
            <button
              ...
              rounded-md transition-colors cursor-pointer ${
                currentTab === tab.label
                  ? "bg-indigo-200 font-medium text-black shadow-sm"
